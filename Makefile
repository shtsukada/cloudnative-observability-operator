...
KIND_CLUSTER ?= cloudnative-observability-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name cloudnative-observability-operator-builder
	$(CONTAINER_TOOL) buildx use cloudnative-observability-operator-builder
